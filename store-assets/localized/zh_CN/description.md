...
LinkedIn 游戏的帮手。自动求解每日谜题（Queens，Sudoku，Pinpoint，Crossclimb），提供连胜纪录和数据分析。
...
_免责声明：这是一个独立的开源教育项目。与 LinkedIn Corporation 无关，亦未获得其资助或认可。“LinkedIn”是 LinkedIn Corporation 的注册商标。_

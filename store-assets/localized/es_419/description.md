# Solucionador de Juegos de LinkedIn

Un ayudante para LinkedIn Games. Resuelve acertijos diarios (Queens, Sudoku, Pinpoint, Crossclimb) con rachas y análisis.
...
- Privado y seguro: Se ejecuta completamente en su navegador. Sus claves de API se cifra localmente mediante AES-256 y nunca se comparten. Active o desactive la telemetría anónima en cualquier momento.

---

_Exención de responsabilidad: Este es un proyecto educativo independiente de código abierto. No está afiliado, patrocinado ni respaldado por LinkedIn Corporation. 'LinkedIn' es una marca registrada de LinkedIn Corporation._
